...
├── src/
│   ├── data/
│   │   ├── loader.py           # Load, validate, clean dataframe
│   │   └── generate_dataset.py # Synthetic dataset generator
│   ├── preprocessing/
│   │   └── text_cleaner.py     # Full NLP cleaning pipeline
│   ├── models/
│   │   ├── trainer.py          # Training, CV, evaluation, saving
│   │   └── predictor.py        # Prediction API (OOP + functional)
│   ├── utils/
│   │   └── helpers.py          # History, report generation, sample plots
│   └── visualization/
│       └── eda.py              # All EDA charts (matplotlib/seaborn)
│
├── artifacts/
│   ├── models/                 # best_model.pkl, tfidf_vectorizer.pkl
│   └── reports/                # PNG charts, model_metrics.json
│
├── streamlit_app/
